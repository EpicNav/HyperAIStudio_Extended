...
// Compile-time pins for the narrow UE 5.8 public APIs used by this no-hard-link adapter.
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(
	FHyperAIStudioCharacterUE58ApiAuditTest,
	"HyperAIStudio.NativeTools.Character.UE58PublicApiAudit",
	EAutomationTestFlags::EditorContext | EAutomationTestFlags::EngineFilter)

bool FHyperAIStudioCharacterUE58ApiAuditTest::RunTest(const FString& Parameters)
{
	(void)Parameters;
